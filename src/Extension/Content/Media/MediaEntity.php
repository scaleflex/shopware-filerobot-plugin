...
class MediaEntity extends Entity
{
     ...
     * @var int|null
     */
    protected $isFilerobot;

    /**
     * @var string|null
     */
    protected $filerobotUrl;

    /**
     * @var string|null
     */
    protected $filerobotUuid;
    ...
    public function getFilerobotUrl(): string
    {
        return $this->filerobotUrl;
    }

    public function setFilerobotUrl(string $filerobotUrl): void
    {
        $this->filerobotUrl = $filerobotUrl;
    }

    public function getIsFilerobot(): int
    {
        return $this->isFilerobot;
    }

    public function setIsFilerobot(int $isFilerobot): void
    {
        $this->isFilerobot = $isFilerobot;
    }

    public function getFilerobotUuid(): string
    {
        return $this->filerobotUuid;
    }

    public function setFilerobotUuid(string $filerobotUuid): void
    {
        $this->filerobotUuid = $filerobotUuid;
    }
