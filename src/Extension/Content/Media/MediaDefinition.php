...
class MediaDefinition extends EntityDefinition
{
    ...
    protected function defineFields(): FieldCollection
    {
        $fields = new FieldCollection([
            ...
            // add new field from filerobot
            (new IntField('is_filerobot', 'isFilerobot'))->addFlags(new ApiAware(), new WriteProtected(Context::SYSTEM_SCOPE)),
            (new StringField('filerobot_url', 'filerobotUrl'))->addFlags(new ApiAware(), new WriteProtected(Context::SYSTEM_SCOPE)),
            (new StringField('filerobot_uuid', 'filerobotUuid'))->addFlags(new ApiAware(), new WriteProtected(Context::SYSTEM_SCOPE)),
